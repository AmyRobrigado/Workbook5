...
cart.sort(function(a, b) { // Sorting through the array of objects
...
/* function returnNameOnly(itemElements) {
...
console.log(cart);
let step1 = cart.map(returnNameOnly);
console.log(step1);
step1.forEach(displayname);
 */